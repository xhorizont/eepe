...
void ModelEdit::tabModelEditSetup()
{
    ...
    populateTmrBSwitchCB(ui->timerModeBCB,g_model.timer[0].tmrModeB);
    populateTimerSwitchCB(ui->timer2ModeCB,g_model.timer[1].tmrModeA);
    populateTmrBSwitchCB(ui->timer2ModeBCB,g_model.timer[1].tmrModeB);
...
void ModelEdit::updateSwitchesTab()
{
    ...
    populateCSWCB(ui->cswitchFunc_13,g_model.customSw[12].func);
    populateCSWCB(ui->cswitchFunc_14,g_model.customSw[13].func);
    populateCSWCB(ui->cswitchFunc_15,g_model.customSw[14].func);
    populateCSWCB(ui->cswitchFunc_16,g_model.customSw[15].func);
    populateCSWCB(ui->cswitchFunc_17,g_model.customSw[16].func);
    populateCSWCB(ui->cswitchFunc_18,g_model.customSw[17].func);
    populateCSWCB(ui->cswitchFunc_19,g_model.customSw[18].func);
    populateCSWCB(ui->cswitchFunc_20,g_model.customSw[19].func);
    populateCSWCB(ui->cswitchFunc_21,g_model.customSw[20].func);
    populateCSWCB(ui->cswitchFunc_22,g_model.customSw[21].func);
    populateCSWCB(ui->cswitchFunc_23,g_model.customSw[22].func);
    populateCSWCB(ui->cswitchFunc_24,g_model.customSw[23].func);
...
void ModelEdit::switchesEdited()
{
    ...
    chAr[12] = (CS_STATE(g_model.customSw[12].func))!=(CS_STATE(ui->cswitchFunc_13->currentIndex()));
    chAr[13] = (CS_STATE(g_model.customSw[13].func))!=(CS_STATE(ui->cswitchFunc_14->currentIndex()));
    chAr[14] = (CS_STATE(g_model.customSw[14].func))!=(CS_STATE(ui->cswitchFunc_15->currentIndex()));
    chAr[15] = (CS_STATE(g_model.customSw[15].func))!=(CS_STATE(ui->cswitchFunc_16->currentIndex()));
    chAr[16] = (CS_STATE(g_model.customSw[16].func))!=(CS_STATE(ui->cswitchFunc_17->currentIndex()));
    chAr[17] = (CS_STATE(g_model.customSw[17].func))!=(CS_STATE(ui->cswitchFunc_18->currentIndex()));
    chAr[18] = (CS_STATE(g_model.customSw[18].func))!=(CS_STATE(ui->cswitchFunc_19->currentIndex()));
    chAr[19] = (CS_STATE(g_model.customSw[19].func))!=(CS_STATE(ui->cswitchFunc_20->currentIndex()));
    chAr[20] = (CS_STATE(g_model.customSw[20].func))!=(CS_STATE(ui->cswitchFunc_21->currentIndex()));
    chAr[21] = (CS_STATE(g_model.customSw[21].func))!=(CS_STATE(ui->cswitchFunc_22->currentIndex()));
    chAr[22] = (CS_STATE(g_model.customSw[22].func))!=(CS_STATE(ui->cswitchFunc_23->currentIndex()));
    chAr[23] = (CS_STATE(g_model.customSw[23].func))!=(CS_STATE(ui->cswitchFunc_24->currentIndex()));
...
{
    g_model.timer[0].tmrModeB = index-(MAX_DRSWITCH-1);
    updateSettings();
}
...
{
    g_model.timer[1].tmrModeB = index-(MAX_DRSWITCH-1);
    updateSettings();
}
